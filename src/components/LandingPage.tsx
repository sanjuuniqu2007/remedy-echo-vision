...
const LandingPage = ({ onNavigate, onShowAuth }: LandingPageProps) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-gray-900 text-white overflow-x-hidden">
      {/* Header */}
          ...
          <div className="relative max-w-md mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="bg-white/20 rounded-lg p-4 mb-4">
                ...
                <p className="text-sm text-purple-100">AI analyzing symptom...</p>
              </div>
              <div className="text-left">
                <div className="bg-green-500/20 rounded-lg p-3 mb-2">
                  <p className="text-sm font-medium text-green-100">Minor cut detected</p>
                  <p className="text-xs text-green-200">Urgency: Low</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-purple-200">Use photo or voice input to describe your symptom</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-purple-200">AI analyzes and scores urgency level instantly</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-purple-200">Receive instant remedy suggestions with explanations</p>
          </div>
        </div>
      </section>
      ...
      {/* Why EchoRemedy */}
      <section className="container mx-auto px-4 py-16">
        <h2 className="text-4xl font-bold text-center mb-12 text-white">Why EchoRemedy?</h2>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 text-white">Try Live Demo</h2>
          <p className="text-purple-200 mb-8">Experience our AI analysis with a sample image</p>
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm p-8">
            <div className="bg-white/10 rounded-lg p-6 mb-6">
              <div className="w-32 h-32 bg-white/20 rounded-lg mx-auto mb-4 flex items-center justify-center">
                <Camera className="h-16 w-16 text-purple-200" />
              </div>
              <Button 
                variant="outline" 
            ...
            <p className="text-sm text-purple-300">This is anonymous, no data is stored</p>
          </Card>
        </div>
      </section>
      ...
      {/* App Screenshots */}
      <section className="container mx-auto px-4 py-16">
        <h2 className="text-4xl font-bold text-center mb-12 text-white">App Preview</h2>
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {[
            ...
            <Card key={index} className="bg-white/5 border-white/10 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="bg-white/10 rounded-lg h-48 mb-4 flex items-center justify-center">
                  <Camera className="h-12 w-12 text-purple-200" />
                </div>
                <h3 className="text-lg font-semibold text-white mb-2">{screen.title}</h3>
                <p className="text-purple-200">{screen.desc}</p>
              </CardContent>
            </Card>
          ))}
        </div>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold mb-6 text-white">Join the Health Revolution</h2>
